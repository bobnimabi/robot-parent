...
import com.robot.og.base.function.QueryBalanceFunction;
 ...
 * @date 2020/7/14
 */
public class QueryBalanceServer  implements IAssemFunction<VipTotalAmountDTO> {


	@Autowired
	private QueryBalanceFunction getRechargeFunction;
